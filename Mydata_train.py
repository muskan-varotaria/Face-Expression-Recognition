# -*- coding: utf-8 -*-
"""
Created on Sat Feb 23 15:19:01 2019
...
def create_training_data():
    for category in emotions:
        ...
        class_num = emotions.index(category)
...
model.add(Conv2D(64, (3, 3), input_shape=(46, 46, 1), activation='relu'))
...
print(emotions[np.argmax(predictions[60])])

img = cv2.resize(X_test[60], (48,48))
